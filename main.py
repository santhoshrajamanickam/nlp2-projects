...
IBM_model_1_EM = IBM('IBM1', corpus, gold_standard=gold_standard_filepath, limit=500)
...
IBM_model_1_Bayesian = IBM('IBM1', corpus, gold_standard=gold_standard_filepath, limit=500)
...
IBM_model_2_EM_uniform = IBM('IBM2', corpus, gold_standard=gold_standard_filepath, limit=500, initialization='uniform')
...
IBM_model_2_EM_random = IBM('IBM2', corpus, gold_standard=gold_standard_filepath, limit=500, initialization='random')
...
IBM_model_2_EM_pretrained = IBM('IBM2', corpus, gold_standard=gold_standard_filepath, limit=500, initialization='IBM1', pretrained_t=IBM_model_1_EM.t)
