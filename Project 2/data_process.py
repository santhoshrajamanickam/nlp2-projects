...
def process_sentences(input_lang, target_lang, input_sentences, target_sentences):
    # use 'Lang' DS from Pytorch seq2seq tutorial
    ...
    for sentence in pairs:
        ...
        input_obj.addSentence(input_sent)
        output_obj.addSentence(target_sent)

    input_obj.addWord('UNK')
    output_obj.addWord('UNK')
