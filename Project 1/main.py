...
print("==============")
IBM_model_1_EM = IBM('IBM1', corpus, gold_standard=gold_standard_filepath, limit=100000)
...
print("====================")
IBM_model_1_Bayesian = IBM('IBM1', corpus, gold_standard=gold_standard_filepath, limit=100000)
...
print("======================")
IBM_model_2_EM_uniform = IBM('IBM2', corpus, gold_standard=gold_standard_filepath, limit=100000, initialization='uniform')
...
print("=====================")
IBM_model_2_EM_random = IBM('IBM2', corpus, gold_standard=gold_standard_filepath, limit=100000, initialization='random')
...
print("=========================")
IBM_model_2_EM_pretrained = IBM('IBM2', corpus, gold_standard=gold_standard_filepath, limit=100000, initialization='IBM1', pretrained_t=IBM_model_1_EM.t)
